 ...
 */
"use strict";
(this["__webpack_jsonp_uu5g04_1_58_8_uu5g04_bricks"] = this["__webpack_jsonp_uu5g04_1_58_8_uu5g04_bricks"] || []).push([["bricks_internal_carousel-editable_js"],{

/***/ "./bricks/internal/carousel-editable.js":
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {

__webpack_require__.r(__webpack_exports__);
/* harmony export */ __webpack_require__.d(__webpack_exports__, {
/* harmony export */   "CarouselEditable": () => (/* binding */ CarouselEditable),
...
/* harmony import */ var _carousel_item_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__("./bricks/carousel-item.js");
/* harmony import */ var _css__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__("./bricks/internal/css.js");
/* harmony import */ var _modal_editation_components__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__("./bricks/internal/modal-editation-components.js");
...
const editableComponentPropsSetup = [{
  name: "type",
  type: "switchSelector",
  label: _bricks_editable_lsi_js__WEBPACK_IMPORTED_MODULE_3__["default"].carousel.typeLabel,
  getProps: () => ({
    items: [{
      value: "circular",
      content: Uu5g05.Utils.Element.create((uu5g04__WEBPACK_IMPORTED_MODULE_1___default().Bricks.Lsi), {
        lsi: _bricks_editable_lsi_js__WEBPACK_IMPORTED_MODULE_3__["default"].carousel.typeValueCircular
      })
    }, {
      value: "final",
      content: Uu5g05.Utils.Element.create((uu5g04__WEBPACK_IMPORTED_MODULE_1___default().Bricks.Lsi), {
        lsi: _bricks_editable_lsi_js__WEBPACK_IMPORTED_MODULE_3__["default"].carousel.typeValueFinal
      })
    }, {
      value: "rewind",
      content: Uu5g05.Utils.Element.create((uu5g04__WEBPACK_IMPORTED_MODULE_1___default().Bricks.Lsi), {
        lsi: _bricks_editable_lsi_js__WEBPACK_IMPORTED_MODULE_3__["default"].carousel.typeValueRewind
      })
    }]
  })
}, [{
  name: "height",
  type: "number",
  label: _bricks_editable_lsi_js__WEBPACK_IMPORTED_MODULE_3__["default"].carousel.height,
  getProps: () => ({
    suffix: "px",
    message: Uu5g05.Utils.Element.create((uu5g04__WEBPACK_IMPORTED_MODULE_1___default().Bricks.Lsi), {
      lsi: _bricks_editable_lsi_js__WEBPACK_IMPORTED_MODULE_3__["default"].carousel.heightMessage
    }),
    step: 8
  })
}, {
  name: "minHeight",
  type: "number",
  label: _bricks_editable_lsi_js__WEBPACK_IMPORTED_MODULE_3__["default"].carousel.minHeight,
  getProps: () => ({
    suffix: "px",
    step: 8
  })
  ...
  name: "interval",
  type: "number",
  label: _bricks_editable_lsi_js__WEBPACK_IMPORTED_MODULE_3__["default"].carousel.intervalLabel,
  getProps: props => ({
    min: 0,
    step: 0.5,
    suffix: "s",
  ...
  name: "displayedItems",
  type: "number",
  label: _bricks_editable_lsi_js__WEBPACK_IMPORTED_MODULE_3__["default"].carousel.displayedItemsLabel,
  ...
  name: "stepByOne",
  type: "bool",
  label: _bricks_editable_lsi_js__WEBPACK_IMPORTED_MODULE_3__["default"].carousel.stepByOneLabel
}], {
  name: "activeIndex",
  type: "number",
  label: _bricks_editable_lsi_js__WEBPACK_IMPORTED_MODULE_3__["default"].carousel.activeIndexLabel,
  getProps: (props, componentProps, items) => ({
    min: 1,
    max: isValidItems(items) ? items.length : 1,
    valueType: "number",
...
const editableAdditionalPropsSetup = [{
  ...
  name: "prevIcon",
  type: "iconPicker",
  label: _bricks_editable_lsi_js__WEBPACK_IMPORTED_MODULE_3__["default"].carousel.prevIconLabel
}, {
  name: "nextIcon",
  type: "iconPicker",
  label: _bricks_editable_lsi_js__WEBPACK_IMPORTED_MODULE_3__["default"].carousel.nextIconLabel
}], [{
  name: "hideControls",
  type: "bool",
  label: _bricks_editable_lsi_js__WEBPACK_IMPORTED_MODULE_3__["default"].carousel.hideControlsLabel
}, {
  name: "hideIndicators",
  type: "bool",
  label: _bricks_editable_lsi_js__WEBPACK_IMPORTED_MODULE_3__["default"].carousel.hideIndicatorsLabel
}]];
const editablePropsSetup = [{
  name: Uu5g05.Utils.Element.create((uu5g04__WEBPACK_IMPORTED_MODULE_1___default().Bricks.Lsi), {
...
const editableItemPropsSetup = {
  setup: _modal_editation_components__WEBPACK_IMPORTED_MODULE_6__.EditItemInfo
};
...
const CarouselEditable = uu5g04__WEBPACK_IMPORTED_MODULE_1___default().Common.VisualComponent.create({
  //@@viewOn:mixins
  mixins: [(uu5g04__WEBPACK_IMPORTED_MODULE_1___default().Common.BaseMixin)],
  //@@viewOff:mixins

  //@@viewOn:statics
  statics: {
    tagName: _bricks_editable_ns_js__WEBPACK_IMPORTED_MODULE_2__["default"].name("CarouselEditable"),
    classNames: {
      main: _bricks_editable_ns_js__WEBPACK_IMPORTED_MODULE_2__["default"].css("carousel-editable ") + _css__WEBPACK_IMPORTED_MODULE_5__["default"].css(_t || (_t = _`
        & + .uu5-bricks-carousel-item {
          position: relative;
          float: none;
        }
      `)),
      switchSelector: _css__WEBPACK_IMPORTED_MODULE_5__["default"].css(_t2 || (_t2 = _`
        .uu5-bricks-switch-selector {
          min-width: auto;
        }
      `))
    },
    lsi: () => _bricks_editable_lsi_js__WEBPACK_IMPORTED_MODULE_3__["default"].carousel
  },
  //@@viewOff:statics

  //@@viewOn:propTypes
  propTypes: {
    component: (uu5g04__WEBPACK_IMPORTED_MODULE_1___default().PropTypes.object.isRequired)
  },
  //@@viewOff:propTypes
  ...
  _renderMoreSettingsModal() {
    return Uu5g05.Utils.Element.create((uu5g04__WEBPACK_IMPORTED_MODULE_1___default().Common.Suspense), {
      fallback: ""
    }, Uu5g05.Utils.Element.create((uu5g04__WEBPACK_IMPORTED_MODULE_1___default().BricksEditable.Modal), {
      shown: true,
      ...
      itemName: _carousel_item_js__WEBPACK_IMPORTED_MODULE_4__["default"].tagName,
      itemDefaultProps: _carousel_item_js__WEBPACK_IMPORTED_MODULE_4__["default"].defaultProps,
  ...
  _getToolbarItems(allChildren) {
    return [Uu5g05.Utils.Element.create((uu5g04__WEBPACK_IMPORTED_MODULE_1___default().Forms.SwitchSelector), {
      items: (allChildren || []).map((item, index) => ({
        value: index,
        content: this.getLsiComponent("itemLabel", undefined, {
          itemNumber: index + 1
        }),
  ...
  _renderItem(allChildren) {
    ...
    if (this.props.inline) {
      childrenToPass = uu5g04__WEBPACK_IMPORTED_MODULE_1___default().Common.Children.map(allChildren, child => uu5g04__WEBPACK_IMPORTED_MODULE_1___default().Common.Element.clone(child, {
        nestingLevel: "bigBox",
        parent: null
      }));
    } else {
  ...
  render() {
    ...
    return Uu5g05.Utils.Element.create((uu5g04__WEBPACK_IMPORTED_MODULE_1___default().Bricks.Div), this.getMainPropsToPass(), Uu5g05.Utils.Element.create((uu5g04__WEBPACK_IMPORTED_MODULE_1___default().BricksEditable.Toolbar), _babel_runtime_helpers_extends__WEBPACK_IMPORTED_MODULE_0___default()({}, this.getMainPropsToPass(), {
...
/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (CarouselEditable);
