...
/* harmony import */ var _babel_runtime_helpers_objectSpread2__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__("../../node_modules/uu_appg01_devkit/node_modules/@babel/runtime/helpers/objectSpread2.js");
...
/* harmony import */ var browser_update__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__("../../node_modules/browser-update/update.npm.full.js");
...
function doCheck() {
  var envConfig;
  if (window.uu5Environment) envConfig = window.uu5Environment.browserUpdate;else if (window.UU5 && window.UU5.Environment) envConfig = window.UU5.Environment.browserUpdate;
  ...
  // finalize opts
  var usedOpts = _babel_runtime_helpers_objectSpread2__WEBPACK_IMPORTED_MODULE_0___default()(_babel_runtime_helpers_objectSpread2__WEBPACK_IMPORTED_MODULE_0___default()({}, opts), envConfig);
  ...
  // detect
  browser_update__WEBPACK_IMPORTED_MODULE_1___default()(usedOpts);
}
...
if (uri.substr(-floatingVersion.length) === floatingVersion) uri = uri.substr(0, uri.length - floatingVersion.length) + "/1.26.4/";
...
if (ex && _typeof(ex) === "object") {
  ...
  if (!("name" in ex)) Object.defineProperty(ex, "name", {
    configurable: true,
    value: "uu5g05-browser-compatibility".split(/[\/\\]/).pop()
  });
  if (!("namespace" in ex)) Object.defineProperty(ex, "namespace", {
    configurable: true,
    value: "Uu5BrowserCompatibility"
  });
}
...
/***/ "../../node_modules/uu_appg01_devkit/node_modules/@babel/runtime/helpers/objectSpread2.js":
/***/ (function(module, __unused_webpack_exports, __webpack_require__) {

var defineProperty = __webpack_require__("../../node_modules/uu_appg01_devkit/node_modules/@babel/runtime/helpers/defineProperty.js");
