const { mount: enzymeMount, shallow: enzymeShallow } = require("enzyme");
...
function mount(jsx, options) {
  ...
  let wrapper = enzymeMount(jsx, { attachTo: container, ...options });
...
function shallow(jsx, options) {
  ...
  let wrapper = enzymeShallow(jsx, options);
  if (inTest) lastWrapper = wrapper;
  return wrapper;
}
...
module.exports = { initTest, mount, shallow, act, waitUntilCalled, waitUntilCalledTimes, waitWhile };
