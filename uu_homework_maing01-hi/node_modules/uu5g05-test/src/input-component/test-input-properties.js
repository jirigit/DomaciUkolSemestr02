...
function testInputProperties(
  setup,
  { valuePropName = "value", defaultWidth = "", defaultValue = undefined, defaultName = undefined } = {}
) {
  ...
  it("checks default property values", async () => {
    ...
    expect(input).toHaveGdsSize(DEFAULT_SIZE_PATH);
  ...
  it(`checks ${valuePropName} property is set to input`, async () => {
    const value = "value-1";
    await setup({ [valuePropName]: value });
  ...
  it("checks onFocus property is properly called", async () => {
    ...
    const { user, input } = await setup({ onFocus: handleFocus, [valuePropName]: "test-value-1" });
  ...
  it("checks onChange property is properly called", async () => {
    ...
    expect(handleChange.mock.lastCall[0]).toMatchObject({
      ...
      //data: { name: props.name, value: props[valuePropName] + newValue },
      data: { value: props[valuePropName] + newValue },
    });
  });
  ...
  it("checks onBlur property is properly called", async () => {
    ...
    props[valuePropName] = "test-value-1";
