const { Session: TestSession } = require("../session.js");
...
try {
  ...
  requireFunc.resolve("uu_appg01_oidc/package.json");
  ...
  jest.doMock("uu_appg01_oidc", () => {
    ...
    class MockAuthenticationService {
      ...
      static async authenticate() {
        await Promise.resolve(); // break out of act() if we're in any
    ...
    Object.assign(MockAuthenticationService, {
      _listeners: {},
      _expiresAt: 0,
      _expiring: false,
      initComplete: false,
    ...
    class Session {
      ...
      getAttribute(name) {
        ...
        let claims = this._identity.claims;
        if (claims) return claims[name];
        let map = {
    ...
    class MockSession extends Session {
      ...
      async mockSetIdentity(identity) {
        ...
        if (!MockAuthenticationService.initComplete) {
          ...
          await act(() => MockAuthenticationService.initPromise);
        }
      }
