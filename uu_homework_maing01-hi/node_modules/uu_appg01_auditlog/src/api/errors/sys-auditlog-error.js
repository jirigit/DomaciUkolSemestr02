...
const CreateAuditLogConfig = {
  UC_CODE: `${SysAuditLogGeneralError.ERROR_PREFIX}sys/logConfig/create/`,

  AuditLogConfigWasCreated: class extends SysAuditLogGeneralError {
    constructor() {
      super(...arguments);
      this.code = `${CreateAuditLogConfig.UC_CODE}auditLogConfigWasCreated`;
    }
  },
};
...
const LogRecordPrivilegedList = {
  UC_CODE: `${SysAuditLogGeneralError.ERROR_PREFIX}sys/logRecord/privilegedList/`,

  InvalidDtoIn: class extends SysAuditLogGeneralError {
    constructor() {
      super(...arguments);
      this.code = `${LogRecordPrivilegedList.UC_CODE}invalidDtoIn`;
      this.message = "DtoIn is not valid.";
    }
  },
  ...
  InvalidIntervalDefinition: class extends SysAuditLogGeneralError {
    constructor() {
      super(...arguments);
      this.code = `${LogRecordPrivilegedList.UC_CODE}invalidIntervalDefinition`;
      this.message = "DtoIn.timeFrom is not before or equal to dtoIn.timeTo.";
    }
  },
};
...
const PrivilegedDelete = {
  UC_CODE: `${SysAuditLogGeneralError.ERROR_PREFIX}sys/logRecord/privilegedDelete/`,

  InvalidDtoIn: class extends SysAuditLogGeneralError {
    constructor() {
      super(...arguments);
      this.code = `${PrivilegedDelete.UC_CODE}invalidDtoIn`;
      this.message = "DtoIn is not valid.";
    }
  },
  ...
  DaoFailed: class extends SysAuditLogGeneralError {
    constructor() {
      super(...arguments);
      this.code = `${PrivilegedDelete.UC_CODE}daoFailed`;
      this.message = "DAO method failed.";
    }
  },
};
