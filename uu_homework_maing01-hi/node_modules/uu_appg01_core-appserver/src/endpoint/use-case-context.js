...
class UseCaseContext {
  ...
  /**
   * Returns value of custom use case execution attribute.
   * @param {*} name Name of attribute
   * @returns {Object|null} Value of attribute
   */
  static getAttribute(name) {
    let ctx = UseCaseContext._getInstance();
    return ctx ? ctx.attributes[name] : null;
  }

  /**
   * Returns names of all stored of custom use case execution attributes.
   * @returns {Array<String>} Names of stored attributes
   */
  static getAttributeNames() {
    let ctx = UseCaseContext._getInstance();
    return ctx ? Object.keys(ctx.attributes) : [];
  }
  ...
  /**
   * Stores custom use case execution attribute.
