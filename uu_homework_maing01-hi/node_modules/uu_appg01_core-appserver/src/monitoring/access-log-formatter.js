...
const { MessageFormatter, LoggerMDC } = require("uu_appg01_core-logging");
...
class AccessLogFormatter extends MessageFormatter {
   ...
   * * <b>%e</b> - Full {UuApp::Logging::LoggerMdc logger MDC} in JSON format.
   ...
   * * <b>%{ KEY }e</b> - Custom attribute from logger {UuApp::Logging::LoggerMdc logger MDC} with name KEY.
    ...
    switch (tag) {
      ...
      case "B":
        switch (opts) {
          ...
          case undefined:
          case "response":
            result = '(message.res && message.res.responseBodySize) || 0';
            break;
          case "request":
