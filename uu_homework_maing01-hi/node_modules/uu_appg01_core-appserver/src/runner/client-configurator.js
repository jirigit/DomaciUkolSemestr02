...
class ClientConfigurator {
  ...
  static async configureClient() {
    ...
    // TODO Next major - remove setting of UU5.Environment, keep only uu5Environment.
    let configContent = `var uu5Environment = ${Json.stringify(clientConfig)};\nvar UU5 = window.UU5 || {};\nUU5.Environment = uu5Environment;`;
