...
const UU_APP_SERVER_DEPENDENCY_VERSION_2X = "2.+";
const UU_APP_SERVER_DEPENDENCY_VERSION_4X = "4.+";
const UU_APP_SERVER_DEPENDENCY_VERSION_5X = "[5.0,6.0[";

const UU_APP_DEVKIT_1x_VERSION = "1.+";
const UU_APP_DEVKIT_3x_VERSION = "3.+";
const UU_APP_DEVKIT_5x_VERSION = "[5.0,6.0[";

module.exports = async function (opts) {
  let {stack, name, namespace, skipInstall, uuAppServerVersion} = opts || {};
  ...
  if (!Fs.existsSync(buildGradlePath)) {
    ...
    let uuAppDevKitVersion;
    let uuAppVersion;
    if (["2x"].includes(uuAppServerVersion)) {
      uuAppDevKitVersion = UU_APP_DEVKIT_1x_VERSION;
      uuAppVersion = UU_APP_SERVER_DEPENDENCY_VERSION_2X;
    } else if (["4x"].includes(uuAppServerVersion)) {
      uuAppDevKitVersion = UU_APP_DEVKIT_3x_VERSION;
      uuAppVersion = UU_APP_SERVER_DEPENDENCY_VERSION_4X;
    } else {
      uuAppDevKitVersion = UU_APP_DEVKIT_5x_VERSION;
      uuAppVersion = UU_APP_SERVER_DEPENDENCY_VERSION_5X;
    }
    let context = {
      uuAppVersion,
      uuAppDevKitVersion,
  ...
  if (uuAppServerVersion) {
    cmd += ` -PuuAppServerVersion=${uuAppServerVersion}`;
  }
  if (skipInstall != null) {
