...
buildscript {
  ext {
    ...
    uuProdRepository = 'https://repo.plus4u.net/repository/public-java/'
    uuBetaRepository = 'https://repo.plus4u.net/repository/public-java-beta/'
    uuDevRepository = 'https://repo.plus4u.net/repository/public-java-dev/'
  }
