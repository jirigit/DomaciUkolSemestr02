        ...
        <div className={Css.content()}>
          ...
          {sessionState === "authenticated" ? (
            <DynamicLibraryComponent
              ...
              productCode="support/<%= context.vendor + context.app.replace(/^./, m => m.toUpperCase()).replace(/g[0-9]+$/, '') %>"
          ...
          <div className={Css.common()}>
            <div>{`<%= context.vendor + context.app.replace(/^./, m => m.toUpperCase()).replace(/g[0-9]+$/, '') %> ${Environment.appVersion}`}</div>
            {license.termsOfUse && (
              <div>
