...
module.exports = async function (config, templateInfo) {
  ...
  if (type === "uu5-app") {
    console.log(`${upgradeVersion} Updating linking of uuGds font in *.html of UVEs.`);
    let uveHtmlFiles = getUveHtmlFiles();
    for (let htmlFile of uveHtmlFiles) {
      let content = fs.readFileSync(htmlFile, "utf-8");
      content = content.replace(/https:\/\/cdn\.plus4u\.net\/uu-gdsg01\/\d+\.\d+\.\d+\//g, "~uu_gdsg01-unicorn/");
