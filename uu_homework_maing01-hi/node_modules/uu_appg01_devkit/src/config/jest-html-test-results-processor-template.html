        ...
        if (console.length) {
          result = (
            <div className="console">
              {console.map((it, i) => (
                <div key={i}>
                  <div className="console-message-wrapper">
                    <UU5.Bricks.Icon className="console-message-icon" {...CONSOLE_ICONS[it.type]} />
                    <div className="console-message">{" " + it.message}</div>
                  </div>
