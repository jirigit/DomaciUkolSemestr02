...
class Es6ExportsReaderPluginUU5 {
  ...
  postProcessExports(exportsWithMeta) {
    for (let [name, desc] of Object.entries(exportsWithMeta)) {
      desc = desc.type;
          ...
          if (propTypesDesc) {
            ...
            if (Array.isArray(properties)) {
              for (let i = properties.length - 1; i >= 0; i--) {
                ...
                if (typeof name === "string" && name.match(/^(propTypes|defaultProps|displayName|uu5Tag)$/)) {
