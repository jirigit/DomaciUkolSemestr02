...
class uuLogStoreExportTask {
  ...
  async _getExport() {
    ...
    while (true) {
      ...
      if (typeof this.params.timeWindowType === "string") {
        query.set("timeWindowType", this.params.timeWindowType);
      }
      if (typeof this.params.pageSize === "number") {
        var maxPageSize = Math.trunc(this.params.pageSize);
        query.set("pageSize", maxPageSize);
      }
      if (typeof this.params.pageIndex === "number") {
        query.set("pageIndex", Math.trunc(this.params.pageIndex));
      }
