...
let { setConfig, config, originalPaths, originalVersions, onlineWorkspaceProjects, offlineWorkspaceProjects } =
...
let jsx = <Controls config={config} originalPaths={originalPaths} originalVersions={originalVersions} />;
