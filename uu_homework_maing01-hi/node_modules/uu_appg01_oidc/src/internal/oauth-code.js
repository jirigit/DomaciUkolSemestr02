...
const LocalDomainScopeHandler = require("./local-domain-scope-handler.js");
...
class OAuthCode {
  ...
  async get(clientId, scope = null) {
    ...
    await this._discovery.getMetadata();
    return new Promise((resolve, reject) => {
      ...
      this.getAuthorizationUri(redirectUri, clientId, null, scope).then(
        (authzUri) => opn(authzUri),
        (error) => reject(error)
      )
    });
  }
  ...
  async getAuthorizationUri(redirectUri, clientId, acrValues, scope = null) {
    ...
    scope = LocalDomainScopeHandler.transformScope(scope)
