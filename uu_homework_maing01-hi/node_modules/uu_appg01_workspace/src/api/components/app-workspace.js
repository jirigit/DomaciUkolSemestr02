...
class AppWorkspace {
  ...
  /**
   * Sets awid to assigned sysState
   *
   * @param {string} awid awid
   * @param adviceNote note about current awid sysState
   * @returns {Promise<Object>} uuObject sysAppWorkspace
   */
  async setAssignedSysState(awid, adviceNote = {}) {
    return await AppWorkspaceAbl.setAssignedSysState(awid, { adviceNote });
  }

  /**
   * Sets awid to created sysState
   *
   * @param {string} awid awid
   * @returns {Promise<Object>} uuObject sysAppWorkspace
   */
  async setCreatedSysState(awid) {
    return await AppWorkspaceAbl.setCreatedSysState(awid);
  }

  /**
   * Sets awid to assigned sysState
   *
   * @param {Object} dtoIn awid
   * @param {Object} [adviceNote] note about current awid sysState
   * @returns {Promise<Object>} uuObject sysAppWorkspace
   */
  async assign(dtoIn, adviceNote = {}) {
    return await AppWorkspaceAbl.assign({ dtoIn, uuIdentity: adviceNote.uuIdentity });
  }
   ...
   * @returns {Promise<Object>} uuObject sysAppWorkspace
   */
  async unassign(dtoIn, adviceNote = {}) {
    return await AppWorkspaceAbl.unassign({ dtoIn, uuIdentity: adviceNote.uuIdentity });
  }
   ...
   * @returns {Promise<Object>} uuObject sysAppWorkspace
   */
  async reassign(dtoIn, adviceNote = {}) {
    return await AppWorkspaceAbl.reassign({ dtoIn, uuIdentity: adviceNote.uuIdentity });
  }
   ...
   * @returns {Promise}
   */
  async delete(uri, awid) {
    return await AppWorkspaceAbl.delete(uri, { awid });
  }
  ...
  async load(uri, session, uuAppErrorMap = {}) {
    return await AppWorkspaceAbl.load(uri, session, uuAppErrorMap);
  }
  ...
  async loadBasicData(uri, session, uuAppErrorMap = {}) {
    return await AppWorkspaceAbl.loadBasicData(uri, session, uuAppErrorMap);
  }
