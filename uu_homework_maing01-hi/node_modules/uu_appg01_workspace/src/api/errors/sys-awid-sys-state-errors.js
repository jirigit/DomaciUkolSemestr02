...
class ForbiddenAwidSysStateError extends WorkspaceError {
  static get ERROR_CODE() {
    return `${WorkspaceError.APP_WORKSPACE_LIB_ERROR_PREFIX}forbiddenAwidSysState`;
  }

  constructor(msg, paramMap) {
    super({}, paramMap);
    this.message = msg || "This UC can not be run in the current sysState of the uuAppWorkspace.";
