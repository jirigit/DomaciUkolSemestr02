...
const SysDump = {
  UC_CODE: `${WorkspaceError.APP_INSTANCE_ERROR_PREFIX}dump/`,
...
const SysRestore = {
  UC_CODE: `${WorkspaceError.APP_INSTANCE_ERROR_PREFIX}restore/`,
...
const SysAwidRestore = {
  UC_CODE: `${WorkspaceError.APP_WORKSPACE_ERROR_PREFIX}restore/`,
...
const SysImport = {
  UC_CODE: `${WorkspaceError.APP_WORKSPACE_ERROR_PREFIX}import/`,
  SysUuAppWorkspaceDoesNotExist: class extends WorkspaceError {
    constructor() {
      super(...arguments);
      this.message = "Object sysUuAppWorkspace does not exist.";
      this.code = `${SysImport.UC_CODE}sysUuAppWorkspaceDoesNotExist`;
    }
  },
...
const SysListImportMappings = {
  UC_CODE: `${WorkspaceError.APP_WORKSPACE_ERROR_PREFIX}listImportMappings/`,
  InvalidDtoIn: class extends WorkspaceError {
    constructor() {
      super(...arguments);
      this.message = "DtoIn is not valid.";
